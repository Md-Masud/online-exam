...
<tbody>
		...
		<tr >
			...
			<input type="number" name="questionno" value=""placeholder="Question NO" >
		</tr ><br>
		<tr >
		...
		<tr >
			...
			<input type="text" name="ans1"placeholder="Choice One"value="<?php// $data['ans']?>"><br>
		</tr>
		<tr >
		...
		<tr >
			...
			<input type="text" name="ans3"placeholder="Choice Three" value="<?php // $data['ans'] ?>"><br>
		</tr>
		<tr >
			
			<input type="text" name="ans4"placeholder="Choice Four"value="<?php  //$data['ans'] ?>"><br>
		</tr>
		<tr >
